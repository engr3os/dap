...
""" The data extractor is based on timestamp categories.i.e. fields that shared the same timestamp are extracted into same dictionary"""
data = []
...
def extractor(folder_name):
	...
	folder = os.path.split(os.path.abspath(folder_name))[1]
...
if __name__ == "__main__":
	args = sys.argv[1:]
	folder_name = args[0]
	data_out, folder = extractor(folder_name)
